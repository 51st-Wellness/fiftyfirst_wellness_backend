...
async function main() {
  ...
  console.log(
    '🔄 Starting backfill for missing Product rows from StoreItem...',
  );

  // Insert Product rows for any StoreItem.productId that does not yet exist in Product
  // Postgres syntax: NOW() returns timestamp
  ...
  console.log(
    '✅ Backfill complete. All StoreItems now have corresponding Product rows.',
  );
}
